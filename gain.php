...
<head>
    ...
    <link rel="stylesheet" href='/static/css/sections/gain.css'>
...
<body>
    ...
    <div class="back"> 
        <div class="container my-3 text-center">
            <h1 class='my-2'> Muscle Training  </h1>

            <div class="about">
    
                <!-- <a class="btn btn-outline-light" style="min-width:5rem; border-radius:100px;padding: 10px;" href="/templates/sections/full_more.html">More About</a> -->
            </div>
