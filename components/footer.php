<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:xyz@gmal.com"><i class="fas fa-envelope"></i> enigma@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>Team ENIGMA</span> | all rights reserved!</div>
