...
<a class="homi" href="home.php"><img src="images/back.png" alt=""></a>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> Badges <span class="icon-arrow">&UpArrow;</span></th>
                ...
                <tbody>
                    <tr>
                        <td> 1 </td>
                        <td> <img src="images/Zinzu Chan Lee.jpg" alt="">Luffy</td>
                        <td> Seoul </td>
                        <td> 17 Dec, 2022 </td>
                        <td>
...
table_headings.forEach((head, i) => {
    ...
    head.onclick = () => {
        ...
        if (i === 5) { // Assuming the "Points" column is at index 5
            // Sort by points
            sortTableByPoints(sort_asc);
        } else {
...
function sortTableByPoints(sort_asc) {
    [...table_rows].sort((a, b) => {
        let first_row = parseInt(a.querySelectorAll('td')[5].textContent.trim()),
            second_row = parseInt(b.querySelectorAll('td')[5].textContent.trim());
